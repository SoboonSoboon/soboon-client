export { DetailHeader } from '@/components/marketplace/DetailHeader';
export { DetailContent } from '@/components/marketplace/DetailContent';
export { DetailContentFooter } from '@/components/marketplace/DetailContentFooter';
