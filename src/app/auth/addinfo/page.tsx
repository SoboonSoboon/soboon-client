    ...
    <div className="min-h-screen px-4 py-8">
      <div className="mx-auto max-w-md">
        ...
        <button
          ...
          className="bg-primary w-full cursor-pointer rounded-[8px] py-4 text-lg font-semibold text-white transition-colors hover:bg-green-600 disabled:cursor-not-allowed disabled:bg-gray-300"
        >
          저장하기
        </button>
      </div>
